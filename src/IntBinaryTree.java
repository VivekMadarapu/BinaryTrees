...
public class IntBinaryTree {
    ...
    private IntBinaryTree(IntTreeNode overallRoot, boolean copy) {
        if (copy) {
    ...
    // post: constructs a perfect binary tree of given height with random
    //       data values between 0 and 99 inclusive
    public IntBinaryTree(int height) {
        if (height < 0) {
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof IntBinaryTree) {
            IntBinaryTree other = (IntBinaryTree) o;
    ...
    public String toString() {
        ...
        StringBuilder result = new StringBuilder(toString(overallRoot, 0, 0, size, height, widest));

        if (overallRoot == null) {
            result = new StringBuilder("overallRoot\n   null");
        } else {
            ...
            firstLine.append(" ".repeat(Math.max(0, spaces)));
            firstLine.append("overallRoot\n");
            ...
            result.insert(0, firstLine.toString());
        }
    ...
    private String toString(IntTreeNode root, int sizeAboveLeft, int level,
        ...
        if (root == null) {
            ...
            StringBuilder thisElementLine = new StringBuilder();
            StringBuilder nextLine = new StringBuilder();

            if (root.left == null) {
                // indent this node
                for (int i = 0; i < width * sizeAboveLeft; i++) {
                    thisElementLine.append(" ");
                    if (root.right != null) {
                        nextLine.append(" ");
                    }
                }
            ...
            thisElementLine.append(root);

            if (root.right != null) {
                // insert _____ and \ for right pointer
                nextLine.append(" ".repeat(root.toString().length()));
            ...
            if (root.left == null && root.right == null) {
                ...
                result += thisElementLine + nextLine.toString() + mergeLines(leftLines, rightLines);
            }
    ...
    public static void main(String[] args) {
        IntBinaryTree tree = new IntBinaryTree("[19 [47 [23] [-2 [55]]] [63 null [94 null [28]]]]");
        System.out.println(tree.toBracketedString());
        System.out.println();

        tree = new IntBinaryTree("[12]");
